...
namespace WaterConstants {
	...
	// ディスパッチ数の事前計算
	constexpr int VERTEX_COUNT_PER_ROW = GRID_RESOLUTION + 1;
	constexpr int DISPATCH_GROUPS_X = VERTEX_COUNT_PER_ROW / CS_THREAD_GROUP_SIZE;
	constexpr int DISPATCH_GROUPS_Y = VERTEX_COUNT_PER_ROW / CS_THREAD_GROUP_SIZE;
